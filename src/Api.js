...
const listaVino = [
    ...
    new Vino("Rutini", "blanco", "Chardonnay", 1300, "./assets/Rutini_Chardonnay.jpeg", 14),
    new Vino("Alamos", "tinto", "Cabernet", 1500, "./assets/alamos-cabernet.jpg", 15),
    new Vino("Alamos", "tinto", "Malbec Reserva", 1400, "./assets/alamos-malbec.png", 16),
    new Vino("Alamos", "blanco", "Torrontes", 1350, "./assets/alamos-torrontes.png", 17),
    new Vino("Alamos", "blanco", "Semillon", 1250, "./assets/alamos-chardonnay.jpg", 18),
